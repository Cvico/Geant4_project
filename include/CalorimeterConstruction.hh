...
#ifndef CALORIMETERCONSTRUCTION_HH
#define CALORIMETERCONSTRUCTION_HH 
...
class CalorimeterConstruction : public G4VUserDetectorConstruction
{
  public:
    CalorimeterConstruction();
    virtual ~CalorimeterConstruction();
